...
type IProps = NativeStackScreenProps<AppStackParamasType, "Send">;
const Send = ({ navigation }: IProps) => {
  ...
  return (
    ...
    >
      <CustomHeader onPressBack={navigation.goBack} title="Send" />
      <View style={[styles.curve, { backgroundColor: theme.colors.primary }]}>
        ...
        >
          ...
          >
            Select how you want to transfer funds from your account to someone
            else.
          </Text>
          <List.Item
            style={[
            ...
            description="Send funds easily with just a Cashglide username or QR code"
          ...
          <List.Item
            ...
            title="Bank Account"
            titleStyle={[styles.listItemTitle]}
            description="Transfer money straight into recipient’s account"
            descriptionEllipsizeMode="tail"
            descriptionNumberOfLines={2}
            descriptionStyle={styles.listItemDescription}
            left={(prop) => (
